...
namespace DeviceManagement.DL.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "ForeignKey_AuditTrail_User",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestDesciption = table.Column<string>(nullable: true),
                    RejectedComments = table.Column<string>(nullable: true),
                    CancelledComments = table.Column<string>(nullable: true),
                    ReturnedComments = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "ForeignKey_UserDevice_DeviceStatus",
                        column: x => x.Status,
